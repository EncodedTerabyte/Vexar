...
>>>>>>> main
                ...
                if (!flatIndex) {
                    Write("Block Generator", "Failed to calculate flat index for assignment" + StmtLocation, 2, true, true, "");
                    return nullptr;
                }
                ...
                llvm::Value* elementPtr = Builder.CreateInBoundsGEP(elementType, heapArrayPtr, flatIndex);
